def game():
    ...
    # "it is called as infosulution which will write all the pointe of information points in a tab called as help tab " \
    # "it is a thing like def but not def at first" \
    # "it will welcome us and show he to use it in a right way" \

    # it is a point will be writen by a help tab in tkinter
    ...
    def welcome():
        ...
        la = tkinter.Button(hi, text="QUIT GAME HEAR", font="centura 10 ", bg="black", fg="white",
                            command=quiting_welcome_tab).pack()
    ...
    buttonF = tkinter.Button(win, text="Forward", width=10, height=2, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=drawforward).place(y=15, x=20)

    buttonB = tkinter.Button(win, text="Back", width=10, height=2, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=drawbackward).place(y=80, x=20)

    buttonR = tkinter.Button(win, text="Right", width=5, height=1, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=drawright).place(y=60, x=240)

    buttonL = tkinter.Button(win, text="Left", width=5, height=1, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=drawleft).place(y=60, x=180)

    buttonQ = tkinter.Button(win, text="Quit", width=6, height=3, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=quitingmain_tab).place(y=150, x=238)

    buttonC = tkinter.Button(win, text="Clear", width=5, height=3, bg="yellow", fg="black",
                             font="lucida 9 bold underline", command=clearing).place(y=150, x=70)

    buttonhidinng = tkinter.Button(win, text="hide\npen", width=5, height=3, bg="yellow", fg="black",
                                   font="lucida 9 bold underline", command=hide_turtle).place(y=150, x=15)

    buttonreset = tkinter.Button(win, text="Reset", width=5, height=3, bg="yellow", fg="black",
                                 font="lucida 9 bold underline", command=reset).place(y=150, x=185)

    buttoninfo = tkinter.Button(win, text="Help", width=5, height=3, bg="yellow", fg="black",
                                font="lucida 9 bold underline", command=infohelp).place(y=150, x=130)
